...
var lib = exports.lib = ffi.Library('libz3', {
  ...
  Z3_mk_tuple_sort: [z3types.Sort,[z3types.Context,z3types.Symbol,ref.types.uint,z3types.SymbolArray,z3types.SortArray,ref.refType(z3types.FuncDecl),z3types.FuncDeclArray]],
  Z3_mk_enumeration_sort: [z3types.Sort,[z3types.Context,z3types.Symbol,ref.types.uint,z3types.SymbolArray,z3types.FuncDeclArray,z3types.FuncDeclArray]],
  ...
  Z3_mk_constructor: [z3types.Constructor,[z3types.Context,z3types.Symbol,z3types.Symbol,ref.types.uint,z3types.SymbolArray,z3types.SortArray,ArrayType(ref.types.uint)]],
  Z3_del_constructor: [ref.types.void,[z3types.Context,z3types.Constructor]],
  Z3_mk_datatype: [z3types.Sort,[z3types.Context,z3types.Symbol,ref.types.uint,z3types.ConstructorArray]],
  Z3_mk_constructor_list: [z3types.ConstructorList,[z3types.Context,ref.types.uint,z3types.ConstructorArray]],
  Z3_del_constructor_list: [ref.types.void,[z3types.Context,z3types.ConstructorList]],
  Z3_mk_datatypes: [ref.types.void,[z3types.Context,ref.types.uint,z3types.SymbolArray,z3types.SortArray,z3types.ConstructorListArray]],
  Z3_query_constructor: [ref.types.void,[z3types.Context,z3types.Constructor,ref.types.uint,ref.refType(z3types.FuncDecl),ref.refType(z3types.FuncDecl),z3types.FuncDeclArray]],
  Z3_mk_func_decl: [z3types.FuncDecl,[z3types.Context,z3types.Symbol,ref.types.uint,z3types.SortArray,z3types.Sort]],
  Z3_mk_app: [z3types.Ast,[z3types.Context,z3types.FuncDecl,ref.types.uint,z3types.AstArray]],
  Z3_mk_const: [z3types.Ast,[z3types.Context,z3types.Symbol,z3types.Sort]],
  Z3_mk_fresh_func_decl: [z3types.FuncDecl,[z3types.Context,ref.types.CString,ref.types.uint,z3types.SortArray,z3types.Sort]],
  ...
  Z3_mk_distinct: [z3types.Ast,[z3types.Context,ref.types.uint,z3types.AstArray]],
  ...
  Z3_mk_and: [z3types.Ast,[z3types.Context,ref.types.uint,z3types.AstArray]],
  Z3_mk_or: [z3types.Ast,[z3types.Context,ref.types.uint,z3types.AstArray]],
  Z3_mk_add: [z3types.Ast,[z3types.Context,ref.types.uint,z3types.AstArray]],
  Z3_mk_mul: [z3types.Ast,[z3types.Context,ref.types.uint,z3types.AstArray]],
  Z3_mk_sub: [z3types.Ast,[z3types.Context,ref.types.uint,z3types.AstArray]],
  ...
  Z3_mk_map: [z3types.Ast,[z3types.Context,z3types.FuncDecl,ref.types.uint,z3types.AstArray]],
  ...
  Z3_mk_set_union: [z3types.Ast,[z3types.Context,ref.types.uint,z3types.AstArray]],
  Z3_mk_set_intersect: [z3types.Ast,[z3types.Context,ref.types.uint,z3types.AstArray]],
  ...
  Z3_mk_pattern: [z3types.Pattern,[z3types.Context,ref.types.uint,z3types.AstArray]],
  Z3_mk_bound: [z3types.Ast,[z3types.Context,ref.types.uint,z3types.Sort]],
  Z3_mk_forall: [z3types.Ast,[z3types.Context,ref.types.uint,ref.types.uint,z3types.PatternArray,ref.types.uint,z3types.SortArray,z3types.SymbolArray,z3types.Ast]],
  Z3_mk_exists: [z3types.Ast,[z3types.Context,ref.types.uint,ref.types.uint,z3types.PatternArray,ref.types.uint,z3types.SortArray,z3types.SymbolArray,z3types.Ast]],
  Z3_mk_quantifier: [z3types.Ast,[z3types.Context,ref.types.bool,ref.types.uint,ref.types.uint,z3types.PatternArray,ref.types.uint,z3types.SortArray,z3types.SymbolArray,z3types.Ast]],
  Z3_mk_quantifier_ex: [z3types.Ast,[z3types.Context,ref.types.bool,ref.types.uint,z3types.Symbol,z3types.Symbol,ref.types.uint,z3types.PatternArray,ref.types.uint,z3types.AstArray,ref.types.uint,z3types.SortArray,z3types.SymbolArray,z3types.Ast]],
  Z3_mk_forall_const: [z3types.Ast,[z3types.Context,ref.types.uint,ref.types.uint,z3types.AppArray,ref.types.uint,z3types.PatternArray,z3types.Ast]],
  Z3_mk_exists_const: [z3types.Ast,[z3types.Context,ref.types.uint,ref.types.uint,z3types.AppArray,ref.types.uint,z3types.PatternArray,z3types.Ast]],
  Z3_mk_quantifier_const: [z3types.Ast,[z3types.Context,ref.types.bool,ref.types.uint,ref.types.uint,z3types.AppArray,ref.types.uint,z3types.PatternArray,z3types.Ast]],
  Z3_mk_quantifier_const_ex: [z3types.Ast,[z3types.Context,ref.types.bool,ref.types.uint,z3types.Symbol,z3types.Symbol,ref.types.uint,z3types.AppArray,ref.types.uint,z3types.PatternArray,ref.types.uint,z3types.AstArray,z3types.Ast]],
  ...
  Z3_mk_atmost: [z3types.Ast,[z3types.Context,ref.types.uint,z3types.AstArray,ref.types.uint]],
  Z3_mk_pble: [z3types.Ast,[z3types.Context,ref.types.uint,z3types.AstArray,ArrayType(ref.types.int),ref.types.int]],
  ...
  Z3_update_term: [z3types.Ast,[z3types.Context,z3types.Ast,ref.types.uint,z3types.AstArray]],
  Z3_substitute: [z3types.Ast,[z3types.Context,z3types.Ast,ref.types.uint,z3types.AstArray,z3types.AstArray]],
  Z3_substitute_vars: [z3types.Ast,[z3types.Context,z3types.Ast,ref.types.uint,z3types.AstArray]],
  ...
  Z3_benchmark_to_smtlib_string: [ref.types.CString,[z3types.Context,ref.types.CString,ref.types.CString,ref.types.CString,ref.types.CString,ref.types.uint,z3types.AstArray,z3types.Ast]],
  Z3_parse_smtlib2_string: [z3types.Ast,[z3types.Context,ref.types.CString,ref.types.uint,z3types.SymbolArray,z3types.SortArray,ref.types.uint,z3types.SymbolArray,z3types.FuncDeclArray]],
  Z3_parse_smtlib2_file: [z3types.Ast,[z3types.Context,ref.types.CString,ref.types.uint,z3types.SymbolArray,z3types.SortArray,ref.types.uint,z3types.SymbolArray,z3types.FuncDeclArray]],
  Z3_parse_smtlib_string: [ref.types.void,[z3types.Context,ref.types.CString,ref.types.uint,z3types.SymbolArray,z3types.SortArray,ref.types.uint,z3types.SymbolArray,z3types.FuncDeclArray]],
  Z3_parse_smtlib_file: [ref.types.void,[z3types.Context,ref.types.CString,ref.types.uint,z3types.SymbolArray,z3types.SortArray,ref.types.uint,z3types.SymbolArray,z3types.FuncDeclArray]],
  ...
  Z3_fixedpoint_query_relations: [ref.types.int,[z3types.Context,z3types.Fixedpoint,ref.types.uint,z3types.FuncDeclArray]],
  ...
  Z3_fixedpoint_set_predicate_representation: [ref.types.void,[z3types.Context,z3types.Fixedpoint,z3types.FuncDecl,ref.types.uint,z3types.SymbolArray]],
  ...
  Z3_fixedpoint_to_string: [ref.types.CString,[z3types.Context,z3types.Fixedpoint,ref.types.uint,z3types.AstArray]],
  ...
  Z3_tactic_par_or: [z3types.Tactic,[z3types.Context,ref.types.uint,z3types.TacticArray]],
  ...
  Z3_solver_check_assumptions: [ref.types.int,[z3types.Context,z3types.Solver,ref.types.uint,z3types.AstArray]],
  ...
  Z3_mk_injective_function: [z3types.FuncDecl,[z3types.Context,z3types.Symbol,ref.types.uint,z3types.SortArray,z3types.Sort]],
  ...
  Z3_check_assumptions: [ref.types.int,[z3types.Context,ref.types.uint,z3types.AstArray,ref.refType(z3types.Model),ref.refType(z3types.Ast),ref.refType(ref.types.uint),z3types.AstArray]],
  Z3_get_implied_equalities: [ref.types.int,[z3types.Context,z3types.Solver,ref.types.uint,z3types.AstArray,ArrayType(ref.types.uint)]],
  ...
  Z3_get_array_value: [ref.types.void,[z3types.Context,z3types.Model,z3types.Ast,ref.types.uint,z3types.AstArray,z3types.AstArray,ref.refType(z3types.Ast)]],
  ...
  Z3_eval_decl: [ref.types.bool,[z3types.Context,z3types.Model,z3types.FuncDecl,ref.types.uint,z3types.AstArray,ref.refType(z3types.Ast)]],
  ...
  Z3_algebraic_roots: [z3types.AstVector,[z3types.Context,z3types.Ast,ref.types.uint,z3types.AstArray]],
  Z3_algebraic_eval: [ref.types.int,[z3types.Context,z3types.Ast,ref.types.uint,z3types.AstArray]],
  ...
  Z3_rcf_mk_roots: [ref.types.uint,[z3types.Context,ref.types.uint,z3types.RcfNumArray,z3types.RcfNumArray]],
  ...
  Z3_check_interpolant: [ref.types.int,[z3types.Context,ref.types.uint,z3types.AstArray,ArrayType(ref.types.uint),z3types.AstArray,ref.refType(ref.types.CString),ref.types.uint,z3types.AstArray]],
  Z3_write_interpolation_problem: [ref.types.void,[z3types.Context,ref.types.uint,z3types.AstArray,ArrayType(ref.types.uint),ref.types.CString,ref.types.uint,z3types.AstArray]],
